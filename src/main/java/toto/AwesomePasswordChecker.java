...
/**
 * La classe AwesomePasswordChecker fournit des fonctionnalités pour évaluer la sécurité des mots de passe.
 * Elle utilise des centres de clusters et des masques pour mesurer les distances euclidiennes.
 */
public class AwesomePasswordChecker {

    /**
     * Instance unique de AwesomePasswordChecker (singleton).
     */
    private static AwesomePasswordChecker instance;

    /**
     * Liste des centres de clusters.
     */
    private final List<double[]> clusterCenters = new ArrayList<>();

    /**
     * Récupère l'instance unique de AwesomePasswordChecker, en initialisant avec un fichier si nécessaire.
     *
    ...
    /**
     * Récupère l'instance unique de AwesomePasswordChecker, en initialisant avec une ressource interne si nécessaire.
     *
     * @return l'instance de AwesomePasswordChecker.
     * @throws IOException en cas d'erreur de lecture.
     */
    ...
    /**
     * Constructeur privé qui initialise la liste des centres de clusters à partir d'un flux d'entrée.
     *
     * @param is le flux d'entrée contenant les centres de clusters au format CSV.
     * @throws IOException en cas d'erreur de lecture.
     */
    ...
    /**
     * Génère un masque pour le mot de passe donné en fonction de la catégorisation des caractères.
     *
     * @param password le mot de passe à analyser.
     * @return un tableau d'entiers représentant le masque.
     */
    public static int[] maskAff(String password) {
    ...
    /**
     * Calcule la distance minimale entre le mot de passe donné et les centres de clusters.
     *
     * @param password le mot de passe à évaluer.
     * @return la distance euclidienne minimale.
     */
